...
return ( <div className="relative min-h-screen bg-black text-green-400 font-mono flex"> <div className="w-[60%] h-[70%] flex justify-center items-start p-4 overflow-hidden">
<SlotMachineCarousel
...
/> </div>
  ...
  <div className="w-[40%] relative border-l border-green-400 flex flex-col">
    ...
    <div className="border-t border-green-400 p-2 sm:p-4 flex items-center">
      <FloatingInput
        prompt={prompt}
        input={input}
        setInput={setInput}
